                    ...
                    <tr>
                        <td style="padding:32px 24px;">
                            ...
                            <p style="margin:0 0 24px; color:#1f2937; font-size:15px; line-height:22px;">
                                Your tutoring reservation has been cancelled successfully.
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:16px 20px; border-bottom:1px solid #e5e7eb;">
                                        <span
                                            style="display:block; color:#6b7280; font-size:12px; text-transform:uppercase; letter-spacing:0.05em; margin-bottom:4px;">
                                            Tutor
                                        </span>

                                        <span style="display:block; color:#111827; font-size:15px; font-weight:600;">
                                            {{ $tutorName }}
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding:16px 20px; border-bottom:1px solid #e5e7eb;">
                                        ...
                                        <span style="display:block; color:#111827; font-size:18px; font-weight:700;">
                                            {{ $amount }} {{ $currency }}
                                        </span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding:16px 20px;">
                                        ...
                                        <span style="display:block; color:#111827; font-size:15px; line-height:22px;">
                                            {{ $reason }}
                                        </span>
                                    </td>
                                </tr>
                            ...
                            <p style="margin:24px 0 0; color:#6b7280; font-size:13px; line-height:20px;">
                                Your reservation is no longer active. If you have any questions,
                                please contact us.
                            </p>
